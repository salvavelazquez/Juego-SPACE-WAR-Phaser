class Escena2 extends Phaser.Scene {
  ...
  preload() {
    ...
    //archivos de sonido
    this.load.audio('backgroundMusic', '../public/sound/musicafondo.mp3');
    this.load.audio('shootSound', '../public/sound/shoot.mp3');
    this.load.audio('collisionSound', '../public/sound/colision.mp3');
    this.load.audio('explosionSound', '../public/sound/explosion.mp3');
